 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 147 }
 ...
 *     O-- FRONT --+
 */
#define MY_X_PROBE_OFFSET_FROM_EXTRUDER (-25)
#define MY_Y_PROBE_OFFSET_FROM_EXTRUDER (-40.5)

#define NOZZLE_TO_PROBE_OFFSET {MY_X_PROBE_OFFSET_FROM_EXTRUDER , MY_Y_PROBE_OFFSET_FROM_EXTRUDER , 0 }
...
#define XY_PROBE_FEEDRATE (95*60)
...
#define HOMING_FEEDRATE_MM_M { (30*60), (30*60), (7*60) }
